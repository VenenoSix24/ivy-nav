...
const MAX_SCALE = 2;
/**
 * 已经占了九成八以上就不动它。原先卡在九成四，于是留了一圈百分之几的透明边的图标
 * 够不到「裁完顶到板边」的效果 —— 而那圈边正好被看出来了
 */
...
/**
 * 把「透明边距」换算成一次 transform：缩放 + 平移，让图案的最长边正好填满图标遮罩。
 *
